...
const Points = () => {
  ...
  }, [selectedItems, routesParams.uf, routesParams.city]);
    ...
    async function loadPosition() {
      const status = await RNLocation.requestPermission({
        ...
        android: {
          detail: 'coarse',
          rationale: {
            title: 'Precisamos de permissão para acessar sua localização',
            message: '',
            buttonPositive: 'OK',
      ...
      if (!status) {
        Alert.alert(
          'Oooops..., precisamos de sua permissão para obter sua localização!',
        );
        return;
      }
